...
const projectGroups: ProjectGroup[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        image: "/media/sercons-corporate-monopoly-wide.png",
      ...
      },
      {
        ...
        title: "Печатные промоматериалы",
        text: "Разрабатывал каталоги и печатные материалы для компаний: брошюры, лифлеты, журналы и раздаточную продукцию — от структуры и текстов до готовой подачи.",
  ...
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        text: "На примере муки, сахара и кофе показал, как обычная пыль превращается в взрывоопасную среду и почему ATEX — это контроль процесса, оборудования и источников воспламенения, а не просто уборка.",
