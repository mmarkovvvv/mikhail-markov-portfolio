...
const projectGroups: ProjectGroup[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        text: "Переписал и спродюсировал экспертные статьи: просмотры выросли с 150–300 до 4 000+.",
      ...
      },
      {
        ...
        text: "Разработал корпоративную игру для SERCONS: адаптировал «Монополию» под структуру и бизнес-процессы компании — с отделами, кейсами и инсайтами.",
      ...
      },
      {
        ...
        text: "Разработал каталог испытательного центра: показал экспертизу, лаборатории и оборудование «ПромМаш Тест».",
  ...
  },
  {
    ...
    projects: [
      ...
      {
        number: "03",
        category: "Экспертный бренд",
        title: "«Работай на нефть, работай!»",
        text: "Раскрыл профессиональный путь Владимира Надеина: 65 лет в нефтегазовой отрасли, инженерный опыт и взгляд на безопасность.",
        wide: true,
        gallery: [
          {
      ...
      <section className="intro section-shell" id="top">
        <div className="intro-copy" id="about">
          ...
          <p className="intro-text">
            {keepRussianWordsTogether("Редактор и руководитель контента и коммуникаций. 7+ лет превращаю сложные темы в понятные тексты, стратегии и контентные системы — для компаний, брендов и экспертов. Работаю с digital, медиа, видео и внутренними коммуникациями.")}
          </p>
